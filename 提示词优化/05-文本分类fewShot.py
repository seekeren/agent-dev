...
messages = [{"role": "system", "content":"你是金融专家，将文本分类为['新闻报道', '财务报道', '公司公告', '分析师报告'], 不清楚的分类为'不清楚类别' 下面有示例"}]
...
for q in questions:
    reponse = client.chat.completions.create(model="qwen3.6-flash-2026-04-16", messages=messages + [{"role": "user", "content": f"按照示例，回答下面的文本类别。{q}" }])
